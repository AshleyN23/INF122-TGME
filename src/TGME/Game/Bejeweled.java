...
public class Bejeweled extends SwipingGame{ //initally extends Game
    ...
    public void updateBoard(int col, int row) {
        ...
        super.board.updateBoard(col, row); // Calls Board’s update logic
    ...
    public int startGame() {
        ...
        while (gameStart) {
            ...
            if (playerMove[2].equals("Down")) {
                super.swipeDown(Integer.parseInt(playerMove[0]) - 1, Integer.parseInt(playerMove[1]) - 1);
            } else if (playerMove[2].equals("Up")) {
                super.swipeUp(Integer.parseInt(playerMove[0]) - 1, Integer.parseInt(playerMove[1]) - 1);
            } else if (playerMove[2].equals("Left")) {
                super.swipeLeft(Integer.parseInt(playerMove[0]) - 1, Integer.parseInt(playerMove[1]) - 1);
            } else if (playerMove[2].equals("Right")) {
                super.swipeRight(Integer.parseInt(playerMove[0]) - 1, Integer.parseInt(playerMove[1]) - 1);        
            } else {
